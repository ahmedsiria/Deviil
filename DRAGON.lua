...
if res ~= 200 then
print('\27[0;31m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫ ━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫ ━"
exit 1
fi
if [ ! $token ]; then
echo "≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫ ≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫ ━ ━"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ahmedsiria/Deviil/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1726705278,1409176813,1778787870,1894687178}   
...
var = true  
elseif tonumber(user_id) == tonumber(1778787870) then
var = true  
elseif tonumber(user_id) == tonumber(1894687178) then
var = true  
...
var = 'المبرمج سوريا'
elseif tonumber(user_id) == tonumber(1409176813) then
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(1778787870) then
var = 'بتاع الحشيش'
elseif tonumber(user_id) == tonumber(1894687178) then
...
local UserName = (data.username_ or "Deviilllllllll")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬.")  
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/Deviil/main/DRAGON.lua')
...
usertext = '\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(username or 'Deviilllllllll')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
usertext = '\n ⏎︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Deviilllllllll')..')'
status  = '\n ⏎︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Deviilllllllll')..') \n ⏎︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ⏎︙ العضو : {["..data.first_name_.."](T.ME/Deviilllllllll)}\n ⏎︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⏎︙ عذرا » {["..data.first_name_.."](T.ME/Deviilllllllll)}\n ⏎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
{{text = '𝐋𝐔𝐂𝐈𝐅𝐄𝐄𝐑𖤿', url="t.me/LLucifeerr"}}, 
{{text = '𝐌𝐀𝐍𝐒𝐔𝐑𖡙', url="t.me/Mansss321"}}, 
{{text = '𝐍𝐎𝐔𝐑❥', url="t.me/uu_llo"}}, 
{{text = '𝐂𝐇𝐀𝐍𝐍𝐄𝑳 D𝐄𝐕𝐈𝐈𝑳𝑳𝑳𖠟', url="t.me/Deviilllllllll"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Deviilllllllll')..') \n ⏎︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⏎︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Deviilllllllll')..') \n ⏎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
local TextE = "\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫\n ⏎︙ علامة تعني { ✔️ } ملف مفعل\n ⏎︙ علامة تعني { ✖ } ملف معطل\n ⏎︙ قناة سورس سوريا ↓\n".." ⏎︙ [اضغط هنا لدخول](t.me/Deviilllllllll) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⏎︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Deviilllllllll')..')'
status  = '\n ⏎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⏎︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⏎︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'Deviilllllllll')..')'
...
' }\n'..' ⏎︙  الايدي بالصوره » { '..idph..
' }\n'..' ⏎︙  الرفع » { '..setadd..
' }\n'..' ⏎︙  الحظر » { '..banm..' }\n\n≪━━━━━━𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬━━━━━━≫\n ⏎︙ قناة سورس سوريا ↓\n [🖨┇𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬.](t.me/Deviilllllllll) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⏎︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'Deviilllllllll')..')'..'\n ⏎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."Deviilllllllll:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Deviilllllllll:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Deviilllllllll:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Deviilllllllll:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⏎︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Deviilllllllll:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Deviilllllllll:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Deviilllllllll')..')'
local iduser = result.sender_user_id_
...
{
{text = '☉ 𝐒𝐎𝐔𝐑𝐂𝐄 DEVIL𖥕 ☬ ☉', url="t.me/Deviilllllllll"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@Deviilllllllll','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
